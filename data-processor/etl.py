...
class Transform:
    ...
    def transform_median_rent_by_town_and_flat_type_dataset(self) -> numpy.ndarray:
        pass
    

    def transform_renting_out_of_flat_approvals_by_flat_type_quarterly_dataset(self) -> numpy.ndarray:
        pass
